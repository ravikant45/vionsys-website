...
export const Features: FC = () => {
  return (
    <><div className='w-full text-center text-4xl font-bold p-5'><h1>Features</h1></div><div className="relative px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">

          <div className="absolute inset-0">
              <div className="absolute inset-y-0 z-0 w-full h-full bg-blue5 lg:w-3/4" />
          </div>
