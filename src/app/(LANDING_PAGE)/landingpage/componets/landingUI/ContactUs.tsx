  ...
  return (
    <>
      <div className="flex md:justify-evenly justify-center items-center">
        <div className="relative w-full md:h-screen h-[100vh] flex justify-start items-center md:mx-[4%]">
          ...
          <div className="absolute flex w-full md:justify-end justify-center bg-tranparent right-0 m-3">
            
            <div className="md:w-[30rem] rounded-2xl items-center mr-5">
            ...
            <div className="md:w-[25rem] flex-col gap-4 font-extrabold text-MainHeading flex justify-center items-center border-l-2 pl-5 border-slate-200">
              <motion.div 
              ...
              <div className="font-bold text-SubHeading text-center">Let's stay in touch</div>
              {/* social media icons */}
              <motion.div
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
