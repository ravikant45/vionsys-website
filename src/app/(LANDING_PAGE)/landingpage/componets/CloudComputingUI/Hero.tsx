  ...
  return (
    <div className="pt-16">
      <div className="relative">
        <Image src={CloudHero} alt="" className="object-cover w-full h-screen" />
      </div>
      <div className="absolute items-center left-1 h-full top-0 flex md:flex-row flex-col w-full p-2 md:p-10">
        ...
        >
          ...
          <div>
            <h1 className="text-white text-2xl font-semibold mb-2">Highlights:</h1>
            <ul className="list-decimal mb-2 text-white font-medium text-xl px-4">
              <li className="mb-2">Streamlined processes for greater efficiency</li>
          ...
          <button className="relative inline-flex h-12 active:scale-95 transistion overflow-hidden rounded-lg p-[1px] focus:outline-none">
                ...
                <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg px-7 text-sm font-medium text-[#F0F0EE] bg-blue1 backdrop-blur-3xl gap-2 undefined" onClick={() => {
