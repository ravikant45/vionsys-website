...
const Hero: React.FC = () => {
  return (
    <section className="w-[100vw] md:h-screen mmd:h-[70vh] ssm:h-[60vh] h-[50vh]">
            ...
            <div className="flex flex-col items-center justify-between xl:flex-row">
              <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                ...
                <a
                  href="/"
                  aria-label=""
                  className="inline-flex items-center font-semibold tracking-wider transition-colors duration-200 text-orange hover:text-teal-accent-700"
                >
                  Learn more
                  <svg
              ...
              <div className="w-full max-w-xl xl:px-8 xl:w-5/12">
                <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
                  ...
                  <form>
                    ...
                    <div className="mt-4 mb-2 bg-orange sm:mb-4">
                      <button
                        type="submit"
                    ...
                    <p className="text-xs text-gray-600 sm:text-sm">
                      We respect your privacy. Please enter your details.
                    </p>
                  </form>
                </div>
              </div>
