...
const VEmployeeModel = () => {
  ...
  const features = [
    { heading: "Why Choose a Virtual Remote Model?", description: "Boost productivity with Dedicated Employee Model" },
  ...
  return (
    <div className="max-w-screen-xl h-full mx-auto py-5 px-4 lg:px-6 bg-dot-black/[0.2]">
      <div className="flex flex-col lg:flex-row w-full h-auto lg:h-[350px] gap-6">
        ...
        <div className="relative w-full lg:w-[90%] flex flex-col">
          {/* Progress bar */}
          <div className="absolute right-0 top-0 h-full w-1 hidden lg:flex flex-col items-center bg-gray-200">
            <div
              className="bg-blue1 w-1"
              style={{ height: `${scrollProgress}%` }}
            ></div>
            <IoMdArrowDropdownCircle className="text-orange text-xl" />
          </div>
