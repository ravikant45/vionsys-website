...
function Consults() {
  ...
  return (
    <div className="p-6 md:px-16 bg-black text-white/90">
      <div className="mx-auto">
        ...
        <div className="p-6 rounded-2xl bg-dot-slate-500 border border-stone-800 mx-auto">
          <div className="space-y-12">
            {offerings.map(
              ({ title, description, image, reverse, alt }, index) => (
                <div
                  key={index}
                  className={`flex flex-col max-w-6xl bg-black border border-gray-700 rounded-lg ${
