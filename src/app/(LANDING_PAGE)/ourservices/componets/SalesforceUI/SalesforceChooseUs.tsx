...
type HeroSalesforceChooseProps = {
  showModal: boolean;
  setShowModal: React.Dispatch<React.SetStateAction<boolean>>;
};

const Component: React.FC<HeroSalesforceChooseProps> = ({
  showModal,
  setShowModal,
}) => {
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <button
                  ...
                  className="group px-4 py-2 bg-[#4d76aa] text-white rounded-full font-medium flex items-center space-x-2 transition-all duration-300 ease-in-out hover:bg-[#1E77E8]"
                >
