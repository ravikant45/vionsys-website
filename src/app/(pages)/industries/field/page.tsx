...
import Edu4 from "../../../../../public/assets/Industries/Education/Edu4.jpg";
        ...
        <AuroraBackground>
          <div className="relative flex flex-col gap-4 items-center justify-center px-4 md:py-10 py-4 md:h-[60vh] h-[60vh]">
            <div className="flex flex-col justify-center items-center gap-4">
              <h3 className="text-4xl text-[#215cbc] font-extrabold text-center">
                Field Services Sector
              </h3>
              <p className="md:text-lg text-base text-center max-w-5xl">
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className={`flex-1 flex flex-col sm:flex-row flex-wrap -mb-4 -mx-2 ${item.className3}`}>
              <div className="w-full sm:w-1/2 mb-4 px-2">
                <div className={`h-auto py-4 px-6 border border-[#215cbc] border-t-0 ${item.className1}`}>
