    ...
    <div className="w-full dark:bg-black bg-white  dark:bg-grid-white/[0.2] bg-grid-black/[0.2] relative flex lg:flex flex-wrap lg:items-center lg:justify-center" >
      ...
      <div data-aos="zoom-in">
        <CardContainer className="inter-var flex justify-evenly px-6">
          <CardBody className="bg-white lg:h-96 h-auto shadow-blue2 shadow-md relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] w-auto sm:w-[20rem] rounded-xl px-6 border mx-4 py-5 flex flex-col gap-2 items-center">
            <CardItem
              translateZ="50"
