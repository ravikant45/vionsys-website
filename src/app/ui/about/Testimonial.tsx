...
const Testimonial = () => {
  return (
    <>
        <h1 className="text-center text-4xl py-2 font-semibold hover:underline text-blue3">What Our Client's Are Saying</h1>
        ...
        <div className="h-auto w-screen flex justify-center flex-wrap gap-6  py-4">
            <div className="mb-4 text-black w-96 hover:border-l-2 hover:border-b-2 border-blue4 p-4 rounded-bl-2xl ">
            <svg
                height="35px"
                className="mb-2"
                fill="#5a67d8"
