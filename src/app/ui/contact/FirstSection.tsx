...
const Conts = () => {
  return (
      <div>
          <div className="w-[100vw] h-[100vh] pb-4">
          <div className="w-full h-full relative">
                  <img  className="w-full h-full  object-cover bg-no-repeat"
                 ...
                 <h1 className="absolute pl-5 text-white text-6xl font-bold whitespace-normal transition duration-500 slide -in-out hover:text-blue-500">
