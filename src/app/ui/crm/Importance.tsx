...
function Importance() {
  return (
    <div className='grid overflow-x-hidden grid-cols-1 md:px-6 px-2 py-10 bg-slate-100 justify-items-center items-center'>
      <h1 className='text-xl font-bold text-orange text-center'>Why CRM is important for your business</h1>
      <ul className="grid grid-cols-1 justify-center gap-y-10 gap-x-6 items-center md:p-8 p-4">
        <li data-aos="fade-left" className="relative flex md:flex-row flex-col  items-start">
        ...
        <li data-aos="fade-right" className="relative flex md:flex-row flex-col items-start">
          <div className="order-1 sm:ml-6 xl:ml-0 md:px-6 py-3">
