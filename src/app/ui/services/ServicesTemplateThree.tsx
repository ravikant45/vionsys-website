        ...
        <AuroraBackground>
          ...
          >
            <div className="flex flex-col justify-center items-center gap-4">
              <h3 className="text-5xl text-MainHeading font-extrabold text-center">
                {data.mainTitle}
              </h3>
          ...
          <div className="w-full flex flex-col lg:flex-row items-center justify-center gap-6">
            ...
            <div className="w-full lg:w-1/2 p-2">
              <motion.h2
                ...
                className="text-SubHeading font-bold mb-4 text-center md:text-start"
              >
                {data.secondTitle}
              </motion.h2>
              <motion.p
                ...
                className="text-paragraph text-center md:text-start"
              >
                {data.secondSubTitle}
              </motion.p>
            </div>
              ...
              >
                <div className="flex justify-between basis-full gap-2 flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 md:w-[20rem] w-[18rem] h-[22rem] md:h-[22rem] ">
                  ...
                  <div className="!m-0 !p-0 font-normal h-[50%]">
                    <span className="text-black text-sm">{card.message}</span>
                  </div>
                  <Image
                    quality={100}
                    width="300"
