        ...
        {services.map((item) => (
          ...
          >
            ...
            <div className="flex flex-col md:flex-row">
              <div
                className={`mb-6 md:mb-0 md:p-0 p-3 md:w-1/3 w-full ${item.className2}`}
              >
                <Image
              ...
              <div
                className={`flex-1 flex flex-col sm:flex-row flex-wrap -mb-4 -mx-2 ${item.className3}`}
              >
                ...
                <div className="w-full sm:w-1/2 mb-4 px-2 ">
                  ...
                  >
                    ...
                    <p className="text-sm"> {item.Des2}</p>
                  </motion.div>
                </div>
                ...
                <div className="w-full sm:w-1/2 mb-4 px-2 ">
                  ...
                  >
                    ...
                    <p className="text-sm">{item.Des3}</p>
                  </motion.div>
                </div>
                ...
                <div className="w-full sm:w-1/2 mb-4 px-2 ">
                  ...
                  >
                    ...
                    <p className="text-sm">{item.Des4}</p>
                  </motion.div>
                </div>
              </div>
            </div>
