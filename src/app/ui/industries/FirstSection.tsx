    ...
    <div>
      ...
      <section>
        <div className="grid overflow-x-hidden md:grid-cols-2 px-6 grid-cols-1 bg-slate-100 justify-items-center items-center py-6">
          <div className="">
            <p
              data-aos="fade-up"
              className="underline font-semibold text-2xl text-orange"
            >
              Telecommunication Sector
            </p>
            <p data-aos="fade-left" className="text-lg mt-5 text-black">
            ...
            <p
              data-aos="fade-left"
              className="md:text-2xl font-bold text-[#3469bc] md:px-6 px-4 py-3"
            >
              Key offerings:
            </p>
      ...
      <section>
        <div className="grid overflow-x-hidden md:grid-cols-2 px-6 grid-cols-1 py-10 justify-items-center items-center">
          ...
          <div>
            ...
            <p data-aos="fade-up" className="text-sm mt-5 mb-5">
      ...
      <section>
        <div className="bg-black relative">
          ...
          <div className="absolute md:left-1/2 z-10 md:top-40 top-48 px-3 flex justify-center items-center flex-col transform text-white">
            <h1
              data-aos="fade-left"
              className="md:text-2xl underline font-bold text-orange text-center"
            >
