        ...
        <div className="grid gap-5 row-gap-8 lg:grid-cols-2">
          <div className="flex flex-col justify-center">
            <div className="max-w-xl mb-6">
              ...
              >
                The construction industry is modernizing as new technologies are
                integrated to improve project management, efficiency, safety and
                compliance. Vionsys IT Solutions India Pvt Ltd provides expert
                IT solutions designed to meet the specific needs of the
                construction industry, helping businesses optimize productivity,
