              ...
              <div className={`lg:py-6 lg:pr-16 ${item.className1}`}>
                ...
                >
                  ...
                  <div className="pt-1 pb-8">
                    ...
                    <p className="text-gray-700">{item.para1}</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="pt-1 pb-8">
                    ...
                    <p className="text-gray-700">{item.para3}</p>
                  </div>
                </motion.div>
              </div>
        ...
        <div className="p-8 bg-blue1 bg-opacity-10 border-t rounded-xl shadow-xl sm:p-16">
          <div className="flex">
            <div className="relative w-full">
              ...
              >
                Vionsys IT Solutions India Pvt. Transform your construction
                industry with Our specialized IT solutions to empower
                construction companies to drive operational efficiencies, drive
                innovation and deliver better project outcomes. Contact us today
                to learn how we can help your organization thrive in a
