  ...
  return (
    <div>
      <div className="px-4 py-5 mx-auto bg-dot-slate-300 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <h2 className="w-full border-b border-gray-400 rounded-2xl pb-5 text-center font-bold text-MainHeading text-4xl">
          Our Services
        </h2>
        {Finances.map((data) => (
          <div
            key={data.id}
            className="mb-8 px-5 py-8 bg-white border-b border-gray-400 rounded-2xl"
          >
            ...
            <div className="grid gap-12 row-gap-8 lg:grid-cols-3">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">{data.para1}</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">{data.para2}</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">{data.para3}</p>
                </div>
              </motion.div>
            </div>
          </div>
          ...
          <div className="p-8 bg-slate-500 bg-opacity-10 border-t rounded-xl shadow-xl ">
            <div className="flex">
              <div className="relative w-full">
                ...
                >
                  Vionsys IT Solutions India Pvt. Transform your financial
                  institution with Contact us today to learn how our specialized
                  IT solutions can help you achieve operational efficiencies,
                  ensure compliance, and deliver a better customer experience in
                  finance.
                </motion.p>
