  ...
  return (
    ...
    <div className="w-full h-full relative">
      ...
      <div className="bg-transparent z-10 text-white absolute top-0  h-full flex flex-col justify-center items-center w-full md:px-4 px-2">
        ...
        >
          <h3
            className="font-bold md:text-4xl text-xl"
          >
            Revolutionizing Healthcare<br/> 
            <span className='md:text-2xl text-xl'>Vionsys IT Solutions Advanced IT Solutions for Enhanced Patient Care and Operational Efficiency</span>
          </h3>
