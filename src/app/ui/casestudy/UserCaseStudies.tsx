          ...
          <section className="flex flex-col md:justify-center md:items-center md:flex-row gap-8 bg-gray-100 p-4 rounded-md">
            <div className="flex flex-col justify-center">
              <motion.h1
                ...
                className="text-4xl font-bold top-0 text-gray-800 mb-4 text-center"
              >
                {data?.data.title}
              </motion.h1>

              <div className="flex justify-between bottom-0 pt-16">
                {/* Industry Icon */}
                ...
                <div className="flex gap-4">
                  ...
                  >
                    <FaLinkedinIn
                      size={40}
                      className="text-white bg-black rounded-full p-1 text-center"
                    />
                  </Link>
                  <Link
