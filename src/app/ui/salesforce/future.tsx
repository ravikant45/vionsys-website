...
function Future() {
  return (
    <div className='px-10 py-12 text-center bg-slate-100'>
      <h1 data-aos="fade-left" className='text-2xl font-bold text-orange text-center py-2'>Companies utilizing Salesforce are poised for favorable future outcomes</h1>
    ...
    <div className="relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-12 xl:max-w-6xl">
      {/* Image Column */}
      <div data-aos="fade-right" className="w-[300] h-44 lg:w-1/2 lg:h-[50vh]">
        <Image className="h-full w-full object-cover" src={Growth} alt='' />
      </div>
      {/* Text Column */}
      <div data-aos="fade-left" className="max-w-lg bg-white md:max-w-2xl border-2 hover:shadow-md hover:shadow-blue2 md:z-10 md:shadow-lg md:absolute md:top-0 md:mt-28 lg:w-3/5 lg:left-0 lg:mt-20 lg:ml-20 xl:mt-24 xl:ml-12">
        {/* Text Wrapper */}
  ...
  <div className="relative flex flex-col items-center mx-auto lg:flex-row lg:max-w-5xl lg:mt-12 xl:max-w-6xl">
    ...
    <div data-aos="fade-right" className="max-w-lg bg-white md:max-w-2xl border-2 hover:shadow-md hover:shadow-blue2 md:z-5 md:shadow-lg md:absolute md:top-0 md:mt-28 lg:w-3/5 lg:right-0 lg:mt-20 lg:ml-20 xl:mt-24 xl:ml-12">
      <div className="flex flex-col p-7 md:px-2">
