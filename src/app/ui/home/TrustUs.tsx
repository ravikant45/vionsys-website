  ...
  const cardsData = [
    {
      ...
      description:
        "With years of experience in the IT solutions industry, Vionsys IT Solutions India Pvt Ltd is renowned for providing high-quality, innovative solutions designed to meet the specific needs of our clients.",
      icon: <span>🏆</span>, // Replace with actual icon component
    },
    {
      title: "Notable Employees",
      description:
        "Our team consists of certified professionals with specialized knowledge and expertise in the latest technology and industry standards, ensuring that your IT infrastructure is in the hands of experts.",
      icon: <span>👥</span>, // Replace with actual icon component
    },
    {
      ...
      <div className="grid md:grid-cols-3 px-2 py-4 grid-cols-1 justify-items-center items-center">
        ...
        <div className="order-1 md:order-2 p-8">
          ...
          <motion.p
            ...
            className="text-SubHeading mt-5 font-bold"
          >
          ...
          >
            ...
            best from Vionsys IT Solutions India Pvt. Ltd. Join our vibrant team
            and explore the limitless possibilities. Here, you will participate
            in new projects, thrive in a collaborative environment, and
            experience a continuous learning program that supports your
            professional development Find the ideal environment to unlock your
            full potential in the dynamic IT career in.
          </motion.p>
        </div>
      </div>
