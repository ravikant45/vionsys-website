...
function ChooseUs() {
  return (
    <div className='grid overflow-x-hidden md:grid-cols-2 px-6 py-4 grid-cols-1 bg-slate-100 justify-items-center items-center'>
      <div className=''>
        <p data-aos="fade-right" className='underline font-semibold text-xl text-orange'>Why choose us?</p>
        ...
        <p data-aos="fade-up" className='text-sm mt-5 mb-5'>Choose us for your IT requirements as we provide innovative solutions, have a team of highly skilled experts, provide reliable support and prioritize customer satisfaction to propel your business towards success.</p>
      </div>
      <div>
