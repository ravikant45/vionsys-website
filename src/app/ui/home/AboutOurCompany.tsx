  ...
  return (
    <div className='grid md:grid-cols-2 grid-cols-1 bg-white justify-items-center items-center overflow-x-hidden'>
      ...
      <div className='col-span-1 px-5'>
        ...
        <div data-aos="fade-down" className='text-paragraph mt-5 pb-4'>Vionys IT Solutions India Pvt Ltd is an innovative IT solutions provider, dedicated to empowering businesses through cutting-edge technology. Focused on customer focus, loyalty, and excellence, we deliver bespoke services that drive digital transformation and growth. Our team of experts works closely with clients to understand their specific requirements, ensuring a high-quality, sustainable solution that delivers lasting results.</div>
        <Link href='/about'>
