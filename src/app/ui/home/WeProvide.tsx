  ...
  const tests = [
    {
      ...
      description:
        "Artificial Intelligence (AI) is a specialized field within computer science dedicated to the development of intelligent machines capable of emulating human behavior.",
    ...
    },
    {
      name: "Testing and QA",
      description:
        "Testing and Quality Assurance (QA) ensure software meets quality standards, functions flawlessly, and satisfies user requirements through evaluation.",
