            ...
            <section className='w-[100vw] py-6'>
                <div className='grid md:grid-cols-5 grid-cols-1 justify-center items-center gap-4 px-8'>
                    ...
                    <div className=' col-span-2 flex flex-col justify-center items-center gap-4 '>
                        <div data-aos="fade-left" className='grid md:grid-cols-3 grid-cols-2 gap-2 border-b'>
                            ...
                            <div className='col-span-2 flex flex-col pl-2 gap-2 py-2'>
                                <h3 className='font-bold text-black'>Requirement Understanding</h3>
                                <p className='text-sm text-gray1'>At the outset, we engage closely with our clients, delving into their pivotal needs and aspirations. This initial phase lays the groundwork for comprehending their unique expectations and workflow intricacies, enabling us to meticulously chart out project specifications with precision.</p>
                            </div>
                        </div>

                        <div data-aos="fade-right" className='grid md:grid-cols-3 grid-cols-2 gap-2 border-b'>
                            ...
                            <div className='col-span-2 flex flex-col pl-2 gap-2'>
                                ...
                                <p className='text-sm text-gray1'>Crafting a thorough blueprint is our forte, encompassing strategic outlines, delineated testing phases, deliverables, and resource requisites. This meticulous approach ensures simplification and seamless implementation of the testing process, driving efficiency and effectiveness throughout.</p>
                            </div>
                        </div>

                        <div data-aos="fade-up" className='grid md:grid-cols-3 grid-cols-2 gap-2 border-b'>
                            <div className='flex justify-center items-center border-r px-2'>
                                <div className='p-4 bg-gray2 rounded-full flex justify-center items-center'>
                            ...
                            <div className='col-span-2 flex flex-col pl-2 gap-2'>
                                ...
                                <p className='text-sm text-gray1'>Post-test plan analysis, our QA team swiftly identifies key objectives, crafting detailed test cases. This includes test data, preconditions, expected results, and postconditions, ensuring precision in our testing approach.</p>
                            </div>
                        </div>
                    </div>
                    {/* middle */}
                    <div className='md:flex hidden justify-center items-center'>
                        <div data-aos="zoom-out" className='col-span-1 w-44 h-44 rounded-full bg-gray2 flex justify-center items-center border-4 border-blue1'>
                    ...
                    <div className='col-span-2 flex flex-col justify-center items-center gap-4'>
                        <div data-aos="fade-left" className='grid md:grid-cols-3 grid-cols-2 gap-2 border-b'>
                            ...
                            <div className='col-span-2 flex flex-col pl-2 gap-2 py-2'>
                                ...
                                <p className='text-sm text-gray1'>
                                    After grasping the project plan and objectives, our developers swiftly select optimal advanced testing tools. We meticulously configure these tools for test execution, culminating in a dependable testing environment to uphold the integrity of our testing procedures.</p>
                            </div>
                        </div>
                        ...
                        <div data-aos="fade-right" className='grid md:grid-cols-3 grid-cols-2 gap-2 border-b'>
                            ...
                            <div className='col-span-2 flex flex-col pl-2 gap-2'>
                                <h3 className='font-bold text-black'>Test Execution & Automation</h3>
                                <p className='text-sm text-gray1'>
                                    As a premier software testing company in India, our adept QA team swiftly executes and automates tests in accordance with the test plan. We promptly initiate retesting to guarantee flawless execution, upholding our commitment to seamless software quality assurance.</p>
                            </div>
                        </div>
                        ...
                        <div data-aos="fade-up" className='grid md:grid-cols-3 grid-cols-2 gap-2 border-b'>
                            ...
                            <div className='col-span-2 flex flex-col pl-2 gap-2'>
                                ...
                                <p className='text-sm text-gray1'>To offer a comprehensive overview for analysis, we meticulously compile a detailed document summarizing the entire process. This includes all tests conducted, the final testing report, and completion metrics, ensuring clarity and transparency in our testing procedures.</p>
                            </div>
                        </div>
                    </div>
                </div>
